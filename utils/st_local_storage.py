"""
Browser local storage for Streamlit
Adapted from: https://gist.github.com/sfc-gh-jcarroll/e73f3ac80dadb5d0f2136d9d949c35a9
"""
...
class StLocalStorage:
    ...
    def __setitem__(self, key: str, value: Any) -> None:
        ...
        localStorage.setItem('{KEY_PREFIX + key}', {value_json});
        """
        with self._container:
