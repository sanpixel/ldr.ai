...
st.set_page_config(page_title="Legal Description", layout="wide")

st.title("🧪 Test: Legal Description")
st.markdown("**File**: `Legal_Description_Snapfinger_Tract1-3.pdf`")
...
with col1:
    ...
    st.write("Click the button below to process the consolidated Legal Description test PDF.")
    
    if st.button("🔄 Process Legal Description PDF", use_container_width=True, type="primary"):
        try:
            # Check if file exists
            pdf_path = "Legal_Description_Snapfinger_Tract1-3.pdf"
            if not os.path.exists(pdf_path):
                ...
                with st.spinner('Processing Legal Description PDF...'):
                    ...
                    if bearings:
                        ...
                        st.success(f"✅ Successfully extracted and populated {len(bearings)} bearings from Legal Description!")
