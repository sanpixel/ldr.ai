...
st.set_page_config(page_title="Snapfinger Tract 3", layout="wide")

st.title("🧪 Test: Snapfinger Tract 3")
st.markdown("**File**: `combine_SNAPFINGER_TRACT-3_LD.pdf`")
...
with col1:
    ...
    st.write("Click the button below to process the third Snapfinger tract test PDF.")
    
    if st.button("🔄 Process Snapfinger Tract 3 PDF", use_container_width=True, type="primary"):
        try:
            # Check if file exists
            pdf_path = "combine_SNAPFINGER_TRACT-3_LD.pdf"
            if not os.path.exists(pdf_path):
                ...
                with st.spinner('Processing Snapfinger Tract 3 PDF...'):
                    ...
                    if bearings:
                        ...
                        st.success(f"✅ Successfully extracted and populated {len(bearings)} bearings from Snapfinger Tract 3!")
