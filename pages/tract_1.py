...
st.set_page_config(page_title="Snapfinger Tract 1", layout="wide")

st.title("🧪 Test: Snapfinger Tract 1")
st.markdown("**File**: `combine_SNAPFINGER_TRACT-1_LD.pdf`")
...
with col1:
    ...
    st.write("Click the button below to process the first Snapfinger tract test PDF.")
    
    if st.button("🔄 Process Snapfinger Tract 1 PDF", use_container_width=True, type="primary"):
        try:
            # Check if file exists
            pdf_path = "combine_SNAPFINGER_TRACT-1_LD.pdf"
            if not os.path.exists(pdf_path):
                ...
                with st.spinner('Processing Snapfinger Tract 1 PDF...'):
                    ...
                    if bearings:
                        ...
                        st.success(f"✅ Successfully extracted and populated {len(bearings)} bearings from Snapfinger Tract 1!")
